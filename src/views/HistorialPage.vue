  ...
  export default {
    data() {
      return {
        ...
        selectedTransaction: null, // Transacción seleccionada para mostrar detalles
      };
    },
    methods: {
      ...
      editTransaction(transaction) {
        ...
        // Podrías abrir un formulario con los datos de la transacción para editar
      ...
      async deleteTransaction(transaction) {
        if (confirm('¿Estás seguro de que quieres eliminar esta transacción?')) {
          try {
            ...
            // Después de eliminar la transacción, actualizamos la lista
